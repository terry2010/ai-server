      ...
      <div class="header-content">
        <div class="service-info">
          ...
          <div class="service-details">
            <h1 class="service-title">Dify 对话AI平台</h1>
            <p class="service-description">开源的LLM应用开发平台，快速构建AI应用</p>
          </div>
        </div>
...
const service = computed(() => servicesStore.getServiceById('dify'))
...
const handleStart = async () => {
  await servicesStore.startService('dify')
  message.success('正在启动 Dify 服务...')
}

const handleStop = async () => {
  await servicesStore.stopService('dify')
  message.success('正在停止 Dify 服务...')
}

const handleRestart = async () => {
  await servicesStore.restartService('dify')
  message.success('正在重启 Dify 服务...')
}
