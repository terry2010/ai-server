...
.custom-menu :deep(.ant-menu-item:hover) {
  background: linear-gradient(135deg, var(--primary-light) 0%, rgba(0, 122, 255, 0.1) 100%);
...
.custom-menu :deep(.ant-menu-item-selected:hover .anticon) {
  color: var(--text-white) !important;
}

.custom-menu :deep(.ant-menu-divider) {
