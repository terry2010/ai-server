...
export const IPC = {
  ...
  DockerStopAll: 'ai/docker/stopAll',
  DockerRemoveAllContainers: 'ai/docker/removeAllContainers',
  DockerRemoveAllVolumes: 'ai/docker/removeAllVolumes',
  DockerRemoveCustomNetwork: 'ai/docker/removeCustomNetwork',
  DockerNukeAll: 'ai/docker/nukeAll',
  // BrowserView 控制
  BVShow: 'ai/bv/show',
  BVRefresh: 'ai/bv/refresh',
  BVHideAll: 'ai/bv/hideAll',
  BVRelease: 'ai/bv/release',
