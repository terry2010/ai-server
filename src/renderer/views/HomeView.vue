...
const services = ref([
  { serviceName: 'n8n', serviceDescription: '工作流自动化平台，用于连接各种应用和服务', serviceType: 'n8n' as const, status: 'running' as const, cpuUsage: 15, memoryUsage: 32, port: '5678', uptime: '2小时 15分钟' },
  { serviceName: 'Dify', serviceDescription: 'AI 应用开发平台，快速构建和部署 AI 应用', serviceType: 'dify' as const, status: 'stopped' as const, cpuUsage: 0, memoryUsage: 0, port: '3000', uptime: '0分钟' },
  { serviceName: 'OneAPI', serviceDescription: 'OpenAI API 代理服务，统一管理多个 AI 模型接口', serviceType: 'oneapi' as const, status: 'running' as const, cpuUsage: 8, memoryUsage: 18, port: '3001', uptime: '1小时 45分钟' },
  { serviceName: 'RagFlow', serviceDescription: 'RAG 知识库问答系统，基于文档的智能问答', serviceType: 'ragflow' as const, status: 'error' as const, cpuUsage: 0, memoryUsage: 0, port: '9380', uptime: '0分钟' }
])
</script>
